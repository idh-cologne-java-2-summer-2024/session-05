...
public class GenericList<T> {
    ...
    private Object[] data; // das String-Array, das intern benutzt wird
     ...
     * @param initialArray
     */
    public GenericList(String[] initialArray) {
     ...
     * @return
     */
    public GenericList getSubList(int start, int end) {
	GenericList newList = new GenericList(end - start);
	...
	GenericList<Student> studList = new GenericList<Student>();
	studList.add(new Student("Olaf Scholz"));
