...
public class StudentList {
    ...
    private Student[] data; // das String-Array, das intern benutzt wird
     ...
     * @param initialArray
     */
    public StudentList(Student[] initialArray) {
     ...
     * @throws Exception
     */
    public void set(int index, Student s) throws Exception {
     ...
     * @return
     */
    public StudentList getSubList(int start, int end) {
	StudentList newList = new StudentList(end - start);
	...
	Student[] temp = new Student[data.length + 10];
